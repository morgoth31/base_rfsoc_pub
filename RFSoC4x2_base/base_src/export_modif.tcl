...
proc create_hier_cell_radio { parentCell nameHier } {
  ...
  create_bd_pin -dir I -type rst ext_reset
  create_bd_pin -dir O -from 7 -to 0 irq
  create_bd_pin -dir O -from 127 -to 0 m00_axis_tdata
  create_bd_pin -dir O m00_axis_tvalid
  create_bd_pin -dir O -from 127 -to 0 m03_axis_tdata
  create_bd_pin -dir O m03_axis_tvalid
  ...
  connect_bd_net -net receiver_aresetn_adc0 [get_bd_pins aresetn_adc0] [get_bd_pins receiver/aresetn_adc0] [get_bd_pins rfdc/m0_axis_aresetn]
  connect_bd_net -net receiver_aresetn_adc2 [get_bd_pins aresetn_adc2] [get_bd_pins receiver/aresetn_adc2] [get_bd_pins rfdc/m2_axis_aresetn]
  ...
  connect_bd_net -net rfdc_m00_axis_tdata [get_bd_pins m00_axis_tdata] [get_bd_pins rfdc/m00_axis_tdata]
  connect_bd_net -net rfdc_m00_axis_tvalid [get_bd_pins m00_axis_tvalid] [get_bd_pins rfdc/m00_axis_tvalid]
  connect_bd_net -net rfdc_m03_axis_tdata [get_bd_pins m03_axis_tdata] [get_bd_pins rfdc/m03_axis_tdata]
  connect_bd_net -net rfdc_m03_axis_tvalid [get_bd_pins m03_axis_tvalid] [get_bd_pins rfdc/m03_axis_tvalid]
  ...
  connect_bd_net -net usp_rf_data_converter_0_clk_adc0 [get_bd_pins clk_adc0] [get_bd_pins receiver/clk_adc0] [get_bd_pins rfdc/clk_adc0] [get_bd_pins rfdc/m0_axis_aclk]
  connect_bd_net -net usp_rf_data_converter_0_clk_adc2 [get_bd_pins clk_adc2] [get_bd_pins receiver/clk_adc2] [get_bd_pins rfdc/clk_adc2] [get_bd_pins rfdc/m2_axis_aclk]
...
proc create_root_design { parentCell } {
  ...
  set_property CONFIG.NUM_MI {2} $axi_hpm1_fpd
  ...
  set_property CONFIG.NUM_PORTS {6} $axi_intc_concat
...
\
  ...
  connect_bd_intf_net -intf_net axi_hpm0_lpd_M01_AXI [get_bd_intf_pins axi_dma_0/S_AXI_LITE] [get_bd_intf_pins axi_hpm0_lpd/M01_AXI]
  ...
  connect_bd_intf_net -intf_net axi_hpm0_lpd_M06_AXI [get_bd_intf_pins axi_dma_1/S_AXI_LITE] [get_bd_intf_pins axi_hpm0_lpd/M06_AXI]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI1 [get_bd_intf_pins axi_interconnect_0/M00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_LPD]
  ...
  connect_bd_net -net proc_sys_reset_1_interconnect_aresetn [get_bd_pins axi_hpm0_lpd/ARESETN] [get_bd_pins axi_hpm1_fpd/ARESETN] [get_bd_pins proc_sys_reset_0/interconnect_aresetn]
  ...
  connect_bd_net -net radio_aresetn_adc0 [get_bd_pins axis_clock_converter_0/s_axis_aresetn] [get_bd_pins radio/aresetn_adc0]
  connect_bd_net -net radio_aresetn_adc2 [get_bd_pins axis_clock_converter_1/s_axis_aresetn] [get_bd_pins radio/aresetn_adc2]
  connect_bd_net -net radio_clk_adc0 [get_bd_pins axis_clock_converter_0/s_axis_aclk] [get_bd_pins radio/clk_adc0]
  connect_bd_net -net radio_clk_adc2 [get_bd_pins axis_clock_converter_1/s_axis_aclk] [get_bd_pins radio/clk_adc2]
  connect_bd_net -net radio_irq [get_bd_pins axi_intc_concat/In5] [get_bd_pins radio/irq]
  connect_bd_net -net radio_m00_axis_tdata [get_bd_pins axis_clock_converter_0/s_axis_tdata] [get_bd_pins radio/m00_axis_tdata]
  connect_bd_net -net radio_m00_axis_tvalid [get_bd_pins axis_clock_converter_0/s_axis_tvalid] [get_bd_pins radio/m00_axis_tvalid]
  connect_bd_net -net radio_m03_axis_tdata [get_bd_pins axis_clock_converter_1/s_axis_tdata] [get_bd_pins radio/m03_axis_tdata]
  connect_bd_net -net radio_m03_axis_tvalid [get_bd_pins axis_clock_converter_1/s_axis_tvalid] [get_bd_pins radio/m03_axis_tvalid]
  connect_bd_net -net rgbleds_gpio_gpio_io_o [get_bd_ports rgbleds_6bits] [get_bd_pins rgbleds_gpio/gpio_io_o]
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_dma_1/axi_resetn] [get_bd_pins axi_hpm0_lpd/M00_ARESETN] [get_bd_pins axi_hpm0_lpd/M01_ARESETN] [get_bd_pins axi_hpm0_lpd/M02_ARESETN] [get_bd_pins axi_hpm0_lpd/M03_ARESETN] [get_bd_pins axi_hpm0_lpd/M04_ARESETN] [get_bd_pins axi_hpm0_lpd/M05_ARESETN] [get_bd_pins axi_hpm0_lpd/M06_ARESETN] [get_bd_pins axi_hpm0_lpd/M07_ARESETN] [get_bd_pins axi_hpm0_lpd/M08_ARESETN] [get_bd_pins axi_hpm0_lpd/S00_ARESETN] [get_bd_pins axi_hpm1_fpd/M00_ARESETN] [get_bd_pins axi_hpm1_fpd/M01_ARESETN] [get_bd_pins axi_hpm1_fpd/S00_ARESETN] [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins axis_clock_converter_0/m_axis_aresetn] [get_bd_pins axis_clock_converter_1/m_axis_aresetn] [get_bd_pins binary_latch_counter_0/resetn] [get_bd_pins btns_gpio/s_axi_aresetn] [get_bd_pins leds_gpio/s_axi_aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins radio/s_axi_aresetn] [get_bd_pins rgbleds_gpio/s_axi_aresetn] [get_bd_pins sws_gpio/s_axi_aresetn] [get_bd_pins system_management_wiz_0/s_axi_aresetn]
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_dma_1/m_axi_s2mm_aclk] [get_bd_pins axi_dma_1/s_axi_lite_aclk] [get_bd_pins axi_hpm0_lpd/ACLK] [get_bd_pins axi_hpm0_lpd/M00_ACLK] [get_bd_pins axi_hpm0_lpd/M01_ACLK] [get_bd_pins axi_hpm0_lpd/M02_ACLK] [get_bd_pins axi_hpm0_lpd/M03_ACLK] [get_bd_pins axi_hpm0_lpd/M04_ACLK] [get_bd_pins axi_hpm0_lpd/M05_ACLK] [get_bd_pins axi_hpm0_lpd/M06_ACLK] [get_bd_pins axi_hpm0_lpd/M07_ACLK] [get_bd_pins axi_hpm0_lpd/M08_ACLK] [get_bd_pins axi_hpm0_lpd/S00_ACLK] [get_bd_pins axi_hpm1_fpd/ACLK] [get_bd_pins axi_hpm1_fpd/M00_ACLK] [get_bd_pins axi_hpm1_fpd/M01_ACLK] [get_bd_pins axi_hpm1_fpd/S00_ACLK] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins axis_clock_converter_0/m_axis_aclk] [get_bd_pins axis_clock_converter_1/m_axis_aclk] [get_bd_pins binary_latch_counter_0/clk] [get_bd_pins btns_gpio/s_axi_aclk] [get_bd_pins leds_gpio/s_axi_aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins radio/s_axi_aclk] [get_bd_pins rgbleds_gpio/s_axi_aclk] [get_bd_pins sws_gpio/s_axi_aclk] [get_bd_pins system_management_wiz_0/s_axi_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxi_lpd_aclk]
  ...
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces axi_dma_1/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP6/LPD_DDR_LOW] -force
  ...
  exclude_bd_addr_seg -target_address_space [get_bd_addr_spaces axi_dma_1/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP6/LPD_DDR_HIGH]
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces axi_dma_1/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP6/LPD_LPS_OCM]
